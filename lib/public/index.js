(function (l, r) { if (l.getElementById('livereloadscript'))
    return; r = l.createElement('script'); r.async = 1; r.src = '//' + (window.location.host || 'localhost').split(':')[0] + ':35729/livereload.js?snipver=1'; r.id = 'livereloadscript'; l.getElementsByTagName('head')[0].appendChild(r); })(window.document);
(function (global, factory) {
    ...
    */
    ...
    `;
        ...
        async handleCreateCommentClick() {
            await fetchData("http://localhost:3000/Comments", "POST", {
        ...
        async handleDeleteCommentClick(id) {
            await fetchData("http://localhost:3000/Comments/" + id, "PATCH", {
                id: id,
                event: "deleted",
            })
                .then((data) => {
    ...
    .chatroom-comment__new button:hover {
      cursor: pointer;
    }
    ...
    .chatroom-comment__new--dropdown-toggle.open {
      transform: rotate(180deg);
    }
    .chatroom-comment__new--dropdown-toggle:hover {
      cursor: pointer;
    }
  ...
  `;
    ...
    exports.ChatRoom = class ChatRoom extends LitElement {
        static get styles() {
            return css ``;
        }
        connectedCallback() {
    ...
    ], exports.ChatRoom.prototype, "data", void 0);
    exports.ChatRoom = __decorate([
